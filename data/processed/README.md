Two files for two publications :

* MI_OccurrenceCore.csv is the occurrence dataset from the hydrobiology Unit. It includes an entire collection with both indigenous/introduced species.
